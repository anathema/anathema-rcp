...
public class AddToComboListener implements IDoubleClickListener {
  public final ComboEditModel comboEditModel;

  public AddToComboListener(ComboEditModel comboEditModel) {
  ...
  public void doubleClick(DoubleClickEvent event) {
    ...
    if (!selection.isEmpty()) {
      ...
      comboEditModel.addCharmToCombo(charmId);
    }
  }
}