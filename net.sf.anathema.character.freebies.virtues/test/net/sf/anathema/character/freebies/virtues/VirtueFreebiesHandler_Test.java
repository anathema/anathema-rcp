...
public class VirtueFreebiesHandler_Test {
  ...
  private AbstractLimitedFreebiesHandler handler;
  ...
  public void createHandler() throws Exception {
    ...
    ITraitFreebieLimit limit = new ITraitFreebieLimit() {
      @Override
  ...
  public void useCreditForValuesAbove3IfLimitSpecified() throws Exception {
    ...
    AbstractLimitedFreebiesHandler limitedHandler = new VirtueFreebiesHandler(models, limit);
