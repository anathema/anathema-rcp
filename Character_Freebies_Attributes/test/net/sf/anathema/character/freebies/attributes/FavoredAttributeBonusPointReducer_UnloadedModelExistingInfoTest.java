...
public class FavoredAttributeBonusPointReducer_UnloadedModelExistingInfoTest {
  ...
  public void bonusPointsFromMarkerWithoutLoadingModelForExistingResource() throws Exception {
    IMarker[] markers = new IMarker[] { CharacterObjectMother.createBonusPointMarker("favoredAttributes", 3) }; //$NON-NLS-1$
