...
public class MinimalValueFactory  {
  ...
  public MinimalValueFactory(int minimalValue, String templateId) {
    this(minimalValue, templateId, new EclipseExtensionPoint(CharacterTraitPlugin.PLUGIN_ID, POINT_ID).getExtensions());
  }

  public MinimalValueFactory(int minimalValue, String templateId, IPluginExtension... extensions) {
