...
public class CloseCombatShieldStatsGroup extends AbstractValueStatsGroup<IShieldStats> {
  ...
  public void addContent(PdfPTable table, Font font, IShieldStats shield) {
    ...
    if (shield == null) {
      ...
      table.addCell(FinalValueCell.CreateForValue(font, shield.getCloseCombatBonus()));
    }
  }
