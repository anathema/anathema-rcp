...
import net.sf.anathema.character.experience.CharacterExperiencePlugin;
...
public class ToggleExperienceActionDelegate implements IObjectActionDelegate {
  ...
  public void run(IAction action) {
    ...
    try {
      ...
      CharacterExperiencePlugin.getDefaultInstance().log(IStatus.ERROR, Messages.ToggleExperienceActionDelegate_ErrorSavingModel, e);
    }
  }
